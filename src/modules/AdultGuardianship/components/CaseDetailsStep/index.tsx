        ...
        >
            <div className={s['scroll-container-wrapper']}>
                <div className={s['content-description']}>
                    <Typography variant="body-m">Ohio law requires the person for whom guardianship is being sought to be visited and personally served notice of the guardianship application by a probate court investigator.</Typography>
                    <Typography variant="body-m">The information you provide below helps the Court safely notify the Prospective Ward and meet the requirements of Ohio law.</Typography>
                </div>
                <div className={s.inputs}>
                    ...
                    <div className={s['inputs-wrapper']}>
                        <form.AppField
                            name="contactName"
                            children={(field) => {
                                return <field.InputField name="contactName" label={<>Contact person name</>} placeholder="Type contact person full name" onBlur={field.handleBlur} />;
                            }}
                        />
                        <form.AppField
                            name="contactPhone"
                            children={(field) => {
                                return <field.PhoneInputField name="contactPhone" label={<>Contact person telephone number</>} />;
                            }}
                        />
                    </div>
                    <Alert>Please, provide the contact person information, who may be contacted by the court investigator during regular business hours (8:00 a.m. - 5:00 p.m.) if assistance is required to complete service.</Alert>
                </div>
            </div>
